    <!-- Hero Section -->
    <section class="relative min-w-screen min-h-[35rem] bg-cover bg-center bg-fixed z-0" id="home">
      <div class="absolute inset-0 bg-[url('https://cdn.pixabay.com/photo/2024/02/07/15/18/bakery-8559303_1280.jpg')] bg-cover bg-center blur-sm mask-gradient"></div>
      <div class="absolute inset-0 bg-black opacity-40"></div>
      <div class="w-full relative">
        <main class="flex flex-col justify-center items-center content">
